...
export const GAMES: readonly GameMeta[] = [
  {
    ...
    howTo: 'Point one finger at the camera and move it around to paint. Hold your hand over a colour to pick it. Make a fist to stop painting.',
    category: 'camera',
  ...
  },
  {
    ...
    howTo: 'Hold your hand up. The basket follows your hand. Catch the stars and we count together up to ten.',
    category: 'camera',
    ageBands: ['2-3', '3-4'],
  ...
  },
  {
    ...
    howTo: 'Wave your hands anywhere on the screen. Touch a bubble to pop it and hear its colour.',
    category: 'camera',
    ageBands: ['2-3', '3-4'],
  ...
  },
  {
    ...
    howTo: 'Swish your hand across the screen to slice the fruit. No bombs, just yummy fruit!',
    category: 'camera',
    ageBands: ['2-3', '3-4', '4-5'],
